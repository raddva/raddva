...
🎓 an Informatics Student with a strong passion for building impactful software and exploring the world of **Artificial Intelligence**.

## 👩‍💻 About Me
- 🚀 First-year [Informatics](https://bif.telkomuniversity.ac.id/) student at Telkom University, Bandung
- 🔭 Currently diving into the field of **AI** and expanding my skills in **web** and **mobile development**.
- 🌱 Actively learning: `Machine Learning`, `Python`, `React`, `Next.js`, and `Flask`.
- 💬 I love talking about tech, productivity tools, and digital design!
- ✨ Fun fact: When I’m not coding, you’ll find me sketching, painting, or learning design with Adobe tools.

## 💼 Goals
- 👯 Looking to collaborate on open-source projects related to AI, web apps, and developer tools.
- 🤝 Always open to learning from others and sharing knowledge.
...
![](https://nirzak-streak-stats.vercel.app/?user=raddva&theme=dark&hide_border=false)<br/>
...
---
[![](https://visitcount.itsvg.in/api?id=raddva&icon=9&color=2)](https://visitcount.itsvg.in)
